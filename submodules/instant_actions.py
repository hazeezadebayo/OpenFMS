...
class InstantActionsPublisher:
    ...
    def build_instant_action_msg(self, f_id, _r_id, header_id, version, manufacturer, action_list):
        ...
        if self.mqtt_client is not None:
            ...
            # log viz: light purple
            action_types = [a.get("actionType") for a in action_list]
            self.logger.info(f"\033[1;35m[PUBLISHED ACTION] Robot {_r_id}: {action_types}\033[0m")
    ...
    def insert_instant_actions_db(self, instant_action):
        ...
        try:
            ...
            """, (instant_action["headerId"],
                ...
                json.dumps(instant_action["actions"])))
            self.db_conn.commit()

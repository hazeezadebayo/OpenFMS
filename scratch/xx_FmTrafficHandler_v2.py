...
from typing import DefaultDict, Any, Optional, List, Dict, Tuple, Union, cast
        ...
        # idx = ctx.checkpoints.index(next_stop)
        # next_coord = ctx.checkp_itinerary[idx]

        # try:
        #     mex_version             = mex_ctx["version"]
        #     mex_manufacturer        = mex_ctx["manufacturer"]
        #     mex_r_id                = mex_ctx["serial_number"]
        #     mex_agv_position        = mex_ctx["position"]
        #     mex_base                = mex_ctx["base"]
        #     mex_horizon             = mex_ctx["horizon"]
        #     mex_checkpoints         = mex_ctx["c_pnts"]
        #     mex_waitpoints          = mex_ctx["w_pnts"]     # waitpoints,
        #     mex_agv_itinerary       = mex_ctx["c_pnts_pos"] # agv_itinerary,
        #     mex_wait_itinerary      = mex_ctx["w_pnts_pos"] # wait_itinerary,
        #     mex_agv_status          = mex_ctx["agv_status"]
        #     # mex_notifications     = mex_ctx["errors"]
        #     mex_dock_action_done    = mex_ctx["dock_action_done"]
        #     mex_halt                = mex_ctx["halt"]
        #     mex_active_map_name     = mex_ctx["active_map"]
        #     mex_landmarks           = mex_ctx["dock"]       # landmark
        #     mex_order_id            = mex_ctx["order_id"]
        #     mex_header_id           = mex_ctx["header_id"]
        #     # mex_agv_size          = [mex_ctx["agv_size"][0], mex_ctx["agv_size"][1]]
        #     mex_speed_min           = mex_ctx["speed_min"]
        #     # mex_vel_lin_ang       = [mex_ctx["lin_vel"], mex_ctx["ang_vel"]]
        #     mex_merged_nodes        = mex_ctx["merged_nodes"]
        ...
        #         "FmTrafficHandler","_handle_active_mex_conflict","error")
        #     return
        ...
        #     agv_position            =   fb_rec["mex_data"]["position"],
        #     base                    =   fb_rec["mex_data"]["base"],
        #     horizon                 =   fb_rec["mex_data"]["horizon"],
        #     horizon_release         =   fb_rec["mex_data"]["horizon_release"],
        #     checkpoints             =   fb_rec["mex_data"]["c_pnts"],
        #     waitpoints              =   fb_rec["mex_data"]["w_pnts"],
        #     checkp_itinerary        =   fb_rec["mex_data"]["c_pnts_pos"],
        #     waitp_itinerary         =   fb_rec["mex_data"]["w_pnts_pos"],
        #     waitpoints_release      =   fb_rec["mex_data"].get("w_pnts_release", []),
        #     agv_status              =   fb_rec["mex_data"]["agv_status"],
        #     order_timestamp         =   fb_rec["mex_data"]["order_timestamp"],
        #     merged_nodes            =   fb_rec["mex_data"]["merged_nodes"],
        #     dock_action_done        =   fb_rec["mex_data"]["dock_action_done"],
        #     pending_dock_action     =   fb_rec["mex_data"].get("pending_dock_action", None),
        #     halt                    =   fb_rec["mex_data"]["halt"],
        #     errors                  =   fb_rec["mex_data"]["errors"],
        #     active_map_name         =   fb_rec["mex_data"]["active_map"],
        #     landmarks               =   fb_rec["mex_data"]["dock"],
        #     order_id                =   fb_rec["mex_data"]["order_id"],
        #     header_id               =   fb_rec["mex_data"]["header_id"],
        #     agv_size                =   [fb_rec["mex_data"]["agv_size"][0], fb_rec["mex_data"]["agv_size"][1]],
        #     speed_min               =   fb_rec["mex_data"]["speed_min"],
        #     vel_lin_ang             =   [fb_rec["mex_data"]["lin_vel"], fb_rec["mex_data"]["ang_vel"]]
        # )
